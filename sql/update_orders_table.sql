...
CREATE TABLE IF NOT EXISTS order_statuses (
  id VARCHAR PRIMARY KEY,  -- Cambiado a VARCHAR para aceptar strings como 'processing'
...
-- Crear tabla de pedidos si no existe (versión simplificada sin columnas problemáticas)
