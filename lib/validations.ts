...
export function validatePhone(phone: string): { isValid: boolean; error?: string } {
  try {
    ...
    return { isValid: false, error: "Formato de teléfono inválido (ej: +52 55 1234 5678)" }
  }
}
...
export function validateName(name: string): { isValid: boolean; error?: string } {
  try {
    ...
    return { isValid: false, error: "El nombre debe tener entre 2-50 caracteres y solo contener letras" }
  }
}
